  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ color: "#444", lineHeight: 1.5, fontSize: 13 }}>
          {children}
        </div>
...
function UseLayoutEffectuseImperativeHandle() {
  ...
  /** ===== Demo: useImperativeHandle (Input) ===== */
  const inputRef = useRef<ImperativeInputHandle | null>(null);
  const [inputStateLabel, setInputStateLabel] = useState("none");
    ...
    >
      <header style={{ display: "grid", gap: 6 }}>
        ...
        <p style={{ margin: 0, color: "#666", lineHeight: 1.5 }}>
          1) So sánh <strong>useEffect</strong> vs{" "}
          <strong>useLayoutEffect</strong> khi đo layout. 2) Ví dụ{" "}
          <strong>useImperativeHandle</strong> để expose API từ child lên
          parent.
        </p>
      </header>
          ...
          >
            ...
            <button
              onClick={() =>
                setText((prev) =>
                  prev === "Nhãn ngắn"
                    ? "Nhãn dài hơn để bạn thấy width thay đổi"
                    : "Nhãn ngắn",
                )
              }
              style={{
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 12, color: "#777" }}>
              Tip: chọn <strong>useEffect</strong> rồi bấm{" "}
              <strong>Remount</strong> để thấy underline animate từ 0 → width.
            </span>
          </div>
      ...
      >
        ...
        <ImperativeModal ref={modalRef} title="Imperative Modal">
          Đây là ví dụ dễ nhìn về <code>useImperativeHandle</code>: parent gọi{" "}
          <code>modalRef.current.open()</code> để mở modal.
          <br />
          Click ra ngoài overlay để đóng.
        </ImperativeModal>
      </section>

      {/* ===== Card 3: useImperativeHandle (Input) ===== */}
      <section
        style={{
          border: "1px solid #eee",
          borderRadius: 14,
      ...
      >
        ...
        <div style={{ display: "grid", gap: 10 }}>
          ...
          >
            ...
            <button
              onClick={() => {
                ...
                setInputStateLabel(`getValue() = "${val}"`);
              }}
              style={{
                padding: "8px 10px",
                borderRadius: 10,
          ...
          <span style={{ fontSize: 13, color: "#444" }}>
            Last action: <strong>{inputStateLabel}</strong>
          </span>
        </div>
      </section>
    </div>
